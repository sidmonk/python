...
from PyQt5.QtWidgets import QApplication, QMainWindow, QGridLayout, QWidget, QTableWidgetItem, QTableWidget
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        table.setItem(0, 0, self.createItem("1", Qt.ItemIsSelectable | Qt.ItemIsEnabled))
        table.setItem(0, 1,
                      self.createItem("2", Qt.ItemIsEnabled | Qt.ItemIsEditable | Qt.AlignHCenter))
        table.setItem(0, 2,
                      self.createItem("3", Qt.ItemIsSelectable | Qt.ItemIsEnabled | Qt.ItemIsEditable))
